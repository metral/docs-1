---
date: "2020-05-08"
title: "Access Control for Pods on AWS EKS"
authors: ["mike-metral"]
...
AWS [EKS][aws-eks] clusters can use [IAM][aws-iam] roles and policies for Pods
...
In <100 lines of code we've shown how EKS Pods can use AWS IAM to create fine-grained
permissions for apps that integrate with other AWS services.
