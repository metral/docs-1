 ...
 *  The ability to deploy the same app workload multiple times due to Pulumi [auto-naming](https://pulumi.io/reference/programming-model/#autonaming).
...
This integration support eases the transition to Pulumi by making
getting started with Pulumi straight-forward
...
checkpointing & management, and team auth/identity.
